...
import BfCurrentViewerLoggedIn__EditVoice__resolver_reader from '../../BfCurrentViewerLoggedIn/EditVoice/resolver_reader.ts';
        ...
        selections: [
          {
            ...
            alias: "EditVoice",
            arguments: null,
            readerArtifact: BfCurrentViewerLoggedIn__EditVoice__resolver_reader,
            usedRefetchQueries: [],
          },
        ],
      },
